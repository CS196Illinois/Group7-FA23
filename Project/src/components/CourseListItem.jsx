...
import { Card, Text, Modal, Title, Badge, Anchor } from '@mantine/core';

function CourseListItem({ name, description, subject, number, available_term }) {
    ...
    return (
        <>
        <Card shadow="lg" padding="lg" radius="md" m="lg" style={{width: "45vw"}} withBorder>
